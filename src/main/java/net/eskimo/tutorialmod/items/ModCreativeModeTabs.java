package net.eskimo.tutorialmod.items;

import net.eskimo.tutorialmod.TutorialMod;
import net.eskimo.tutorialmod.block.ModBlocks;
...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> ALEXANDRITE_ITEMS_TAB = CREATIVE_MODE_TABS.register("alexandrite_item_tab",
